...
class Company {
   ...
   * @param {string} filters.name - Filter by company name.
   * @param {number} filters.minEmployees - Filter by minimum number of employees.
   * @param {number} filter.maxEmployees - Filter by maximum number of employees.
   * @returns {Array} - The list of matching companies.
  */
